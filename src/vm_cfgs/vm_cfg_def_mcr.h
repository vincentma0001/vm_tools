...
// ==   Modify Time          : 2020-11-11 12:25:05                                               == //
// ==   Issue  List          :                                                                   == //
// ==   Change List          :                                                                   == //
...
#define vHighInt( val )          ((short)(( ((unsigned int)(val)) >> 8) & 0xffff ))
...
#define vHighLong( val )         ((short)(( ((unsigned long)(val)) >> 8) & 0xffff ))
...
#define vHighLLong( val )        ((long)(( ((unsigned long long)(val)) >> 8) & 0xffffffff ))
...
#define vHighuInt( val )         ((unsigned short)(( ((unsigned int)(val)) >> 8) & 0xffff ))
...
#define vHighuLong( val )        ((unsigned short)(( ((unsigned long)(val)) >> 8) & 0xffff ))
...
#define vHighullong( val )       ((unsigned long)(( ((unsigned long long)(val)) >> 8) & 0xffffffff ))
// }}}
// ================================================================================================ //
