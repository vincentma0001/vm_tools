...
vTry
    ...
    // Add unit test coder here
    unsigned long long      lVal1=0;
    vm::CBit64              loBit1(lVal1);
    vm::CBitStr<vm::CBit64> loBitStr1(loBit1);
    loBit1.Set01();
    loBit1.Set02();

    unsigned long long      lVal2=0;
    vm::CBit64              loBit2(lVal2);
    vm::CBitStr<vm::CBit64> loBitStr2(loBit2);
    loBit2.Set01();
    loBit2.Set03();

    unsigned long long      lVal3=0;
    vm::CBit64              loBit3(lVal3);
